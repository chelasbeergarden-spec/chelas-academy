...
const MODULES = [
  ...
  // ===================== SERVER (9) =====================
  {
    ...
    lessons: [
      ...
      { en: "Weekly promos: Uno Mondays ($1 tacos, $6 margaritas all day) · Way Back Wednesday (Live DJ 7pm, 70s/80s/90s) · Jueves de Despecho (Ladies Night, half-off menu from 8pm) · Salsa Fridays (free dance classes + Live DJ 9pm, open till 2am) · Saturday Live DJ 9pm, open till 2am · Sunday Brunch (bottomless mimosas, 99¢ oysters, 12pm–4pm).", es: "Promociones semanales: Uno Mondays ($1 tacos, $6 margaritas todo el día) · Way Back Wednesday (DJ en vivo 7pm, música de los 70s/80s/90s) · Jueves de Despecho (Ladies Night, menú a mitad de precio desde las 8pm) · Salsa Fridays (clases gratis de baile + DJ en vivo 9pm, abierto hasta las 2am) · Sábado DJ en vivo 9pm, hasta las 2am · Brunch dominical (mimosas ilimitadas, ostras a 99¢, 12pm–4pm)." },
      { en: "Taco Tuesday (every week, all day), served as single tacos: Chipotle Chick $2.95, Cochinito $2.95, Vegan $2.95, The Shorty $3.95, Garlic Shrimp $4.95, Shrimp $4.95. Also on the Taco Tuesday menu: Tommy's Margarita (Classic) $6.95 and a House Tequila Shot $4.95.", es: "Taco Tuesday (cada semana, todo el día), servido como tacos individuales: Chipotle Chick $2.95, Cochinito $2.95, Vegano $2.95, The Shorty $3.95, Garlic Shrimp $4.95, Shrimp $4.95. También en el menú de Taco Tuesday: Tommy's Margarita (Classic) $6.95 y un Shot de Tequila de la Casa $4.95." }
    ],
    quiz: [
      ...
      { q: { en: "How much is a single Chipotle Chick or Cochinito taco on Taco Tuesday?", es: "¿Cuánto cuesta un taco individual de Chipotle Chick o Cochinito en Taco Tuesday?" }, options: [{ en: "$2.95", es: "$2.95" }, { en: "$1.00", es: "$1.00" }, { en: "$5.95", es: "$5.95" }, { en: "Free", es: "Gratis" }], correct: 0 },
  ...
  },
  {
    ...
    lessons: [
      { en: "Cócteles ($12.95–$20): Bajapanty $13.95 (Tanduay rum, butterfly pea flower, lychee, lime, soda), Smoke Some $14.95 (The Lost Explorer mezcal, ancho chile, smoked pineapple), Como La Flor $13.95 (Ketel One vodka, Flor de Jamaica, ginger-mint, lemon, soda), Hialeah Ranch Water $15.95 (chile-infused Campo Bravo tequila, Hialeah guava), Gran Reserva Old Fashioned $15.95 (barrel-aged, Ron Zacapa 23), Eau de Vie Gives You Wings $16.95 (Camus Cognac, Valencia orange, Red Bull), Amazonian G&G $14.95 (Canaima gin, Fever-Tree grapefruit soda), The Spicy One $15.95 (Don Julio Blanco + Los Vecinos mezcal, passionfruit, jalapeño-cilantro), The Old Fashioned $15.95 (Bulleit Rye — voted Best Old Fashioned in Miami by our regulars), and Round for the Kitchen $20 (a treat for the kitchen team).", es: "Cócteles ($12.95–$20): Bajapanty $13.95 (ron Tanduay, flor de mariposa, lychee, limón, soda), Smoke Some $14.95 (mezcal The Lost Explorer, chile ancho, piña ahumada), Como La Flor $13.95 (vodka Ketel One, Flor de Jamaica, jengibre-menta, limón, soda), Hialeah Ranch Water $15.95 (tequila Campo Bravo infusionado con chile, guayaba de Hialeah), Gran Reserva Old Fashioned $15.95 (añejado en barril, Ron Zacapa 23), Eau de Vie Gives You Wings $16.95 (Cognac Camus, naranja Valencia, Red Bull), Amazonian G&G $14.95 (gin Canaima, soda de toronja Fever-Tree), The Spicy One $15.95 (Don Julio Blanco + mezcal Los Vecinos, maracuyá, jalapeño-cilantro), The Old Fashioned $15.95 (Bulleit Rye — votado el Mejor Old Fashioned de Miami por nuestros clientes regulares), y Round for the Kitchen $20 (un detalle para el equipo de cocina)." },
      { en: "Margaritas: Tommy's Classic $12.95 (Campo Bravo Plata, agave, lime — add Naranja liqueur shot +$5, add flavor +$2: mango/passionfruit/tamarind/spicy guava/strawberry), Cereza Margarita $14.95, Corona-Rita $22.95 (jumbo Tommy's topped with a Coronita). Frozen: Frozen Margarita $13.45 (same flavor add-ons +$2) and Frozen Piña Colada $14.45 (Flor de Caña rum, pineapple, coconut cream — add rum floater +$5). Tequila Tasting Flights (Don Julio): Beginners $38 (Blanco/Reposado/Añejo), Ballers $52 (Añejo/70th Aniversary/1942).", es: "Margaritas: Tommy's Classic $12.95 (Campo Bravo Plata, agave, limón — agrega shot de licor de Naranja +$5, agrega sabor +$2: mango/maracuyá/tamarindo/guayaba picante/fresa), Cereza Margarita $14.95, Corona-Rita $22.95 (Tommy's jumbo con una Coronita encima). Frozen: Frozen Margarita $13.45 (mismos sabores +$2) y Frozen Piña Colada $14.45 (ron Flor de Caña, piña, crema de coco — agrega ron flotante +$5). Flights de Tequila (Don Julio): Beginners $38 (Blanco/Reposado/Añejo), Ballers $52 (Añejo/70 Aniversario/1942)." },
      { en: "Zero-proof cocktails (always offer as an option, don't assume every guest wants alcohol): Strawberryta $12 (Almave NA tequila, strawberries, lime, agave, salt rim), Yellow Bull $12 (Yellow Edition Red Bull, pineapple, banana-passionfruit), Ponche $10 (maracuya, coconut, orgeat, citrus, soda), Botánico $10 (cucumber, lemon, mint, agave, tonic). Chela's Signature Sangria (white, red, or rosé) $14 glass / $56 pitcher.", es: "Cócteles sin alcohol (siempre ofrécelos como opción, no asumas que todos quieren alcohol): Strawberryta $12 (tequila sin alcohol Almave, fresas, limón, agave, borde de sal), Yellow Bull $12 (Red Bull Edición Amarilla, piña, maracuyá-plátano), Ponche $10 (maracuyá, coco, horchata de almendra, cítricos, soda), Botánico $10 (pepino, limón, menta, agave, tónica). Sangría Insignia de Chela's (blanca, roja, o rosada) $14 copa / $56 jarra." },
      { en: "Beer: Super Bucket — House (5 beers + 5 house tequila shots) $60, Premium (5 beers + 5 Don Julio shots) $85. Draft 19oz ($8–$9): Modelo Especial, Modelo Negra, Mahou, Wynwood La Rubia, Corona Light, Corona Extra, Pacifico, Guinness 16oz. Wine list has whites/rosé, reds, and champagne/bubbles by glass or bottle. Saratoga Spring Water $8 (still or sparkling) — this is our confirmed water brand.", es: "Cerveza: Super Bucket — House (5 cervezas + 5 shots de tequila de la casa) $60, Premium (5 cervezas + 5 shots de Don Julio) $85. De barril 19oz ($8–$9): Modelo Especial, Modelo Negra, Mahou, Wynwood La Rubia, Corona Light, Corona Extra, Pacifico, Guinness 16oz. La carta de vinos tiene blancos/rosados, tintos, y champagne/burbujas por copa o botella. Agua Saratoga $8 (sin gas o con gas) — esta es nuestra marca de agua confirmada." },
      { en: "Coffee is by Coffee Papis Co., locally roasted in South Florida — 100% Arabica from Brazil, Guatemala, and Honduras. Other non-alcoholic ($4–$5): Mexican Coca-Cola, Jarritos, Chicha Morada, Flor de Jamaica, Fresh Lemonade, Red Bull (Classic/Sugar Free/Yellow Edition).", es: "El café es de Coffee Papis Co., tostado localmente en el sur de Florida — 100% Arábica de Brasil, Guatemala y Honduras. Otras bebidas sin alcohol ($4–$5): Mexican Coca-Cola, Jarritos, Chicha Morada, Flor de Jamaica, Limonada Fresca, Red Bull (Clásica/Sin Azúcar/Edición Amarilla)." }
    ],
    flashcards: [
      { front: { en: "Bajapanty — $13.95", es: "Bajapanty — $13.95" }, back: { en: "Tanduay Rum infused with butterfly pea flower, lychee nectar, lime, sparkling water.", es: "Ron Tanduay infusionado con flor de mariposa, néctar de lychee, limón, agua con gas." } },
      { front: { en: "The Old Fashioned — $15.95", es: "The Old Fashioned — $15.95" }, back: { en: "Bulleit Rye Whiskey, Demerara, Ango & Orange Bitters — voted Best Old Fashioned in Miami by our regulars.", es: "Bulleit Rye Whiskey, azúcar Demerara, Ango & Bitters de naranja — votado el Mejor Old Fashioned de Miami por nuestros clientes." } },
      { front: { en: "Tommy's Margarita (Classic) — $12.95", es: "Tommy's Margarita (Classic) — $12.95" }, back: { en: "Campo Bravo Tequila Plata, agave nectar, lime juice. Add Naranja liqueur shot +$5, add flavor +$2.", es: "Campo Bravo Tequila Plata, néctar de agave, jugo de limón. Agrega shot de licor de Naranja +$5, agrega sabor +$2." } },
      { front: { en: "The Spicy One — $15.95", es: "The Spicy One — $15.95" }, back: { en: "Don Julio Blanco Tequila, Los Vecinos Mezcal, passionfruit, jalapeño-cilantro infuse, lime.", es: "Tequila Don Julio Blanco, Mezcal Los Vecinos, maracuyá, jalapeño-cilantro, limón." } },
      { front: { en: "Strawberryta (zero-proof) — $12", es: "Strawberryta (sin alcohol) — $12" }, back: { en: "Almave Non-Alcoholic Tequila, strawberries, lime, agave nectar, salt.", es: "Tequila sin alcohol Almave, fresas, limón, néctar de agave, sal." } },
      { front: { en: "Tequila Flight — Ballers — $52", es: "Flight de Tequila — Ballers — $52" }, back: { en: "Don Julio Añejo, 70th Anniversary, 1942.", es: "Don Julio Añejo, 70 Aniversario, 1942." } },
      { front: { en: "Chela's Signature Sangria", es: "Sangría Insignia de Chela's" }, back: { en: "Available white, red, or rosé — $14 glass / $56 pitcher.", es: "Disponible blanca, roja, o rosada — $14 copa / $56 jarra." } }
    ],
    quiz: [
      ...
      { q: { en: "How much is Chela's Signature Sangria by the glass?", es: "¿Cuánto cuesta la Sangría Insignia de Chela's por copa?" }, options: [{ en: "$14", es: "$14" }, { en: "$56", es: "$56" }, { en: "$5", es: "$5" }, { en: "$30", es: "$30" }], correct: 0 }
    ],
    pass: 80
  },
  {
  ...
  // ===================== BARTENDER (9) =====================
  {
    ...
    lessons: [
      ...
      { en: "Coasters vs. napkins: every guest sitting at the bar gets a coaster under their drink — never a napkin. Napkins are only for guests standing away from the bar, not seated at it.", es: "Posavasos vs. servilletas: todo huésped sentado en la barra recibe un posavaso bajo su bebida — nunca una servilleta. Las servilletas son solo para huéspedes de pie, alejados de la barra, no sentados en ella." },
      { en: "Never throw away an empty bottle unless you have an immediate replacement in hand — set the empty aside for the bar-back to restock. Keep the floor behind the bar clear of debris (no bottle caps or napkins on the floor).", es: "Nunca tires una botella vacía a menos que tengas el reemplazo en la mano — aparta la vacía para que el bar-back la reabastezca. Mantén el piso detrás de la barra libre de residuos (sin tapas de botella ni servilletas en el suelo)." }
    ],
    quiz: [
  ...
  },
  {
    ...
    lessons: [
      { en: "Cocktails ($12.95–$20): Bajapanty, Smoke Some, Como La Flor, Hialeah Ranch Water, Gran Reserva Old Fashioned, Eau de Vie Gives You Wings, Amazonian G&G, The Spicy One, The Old Fashioned, and Round for the Kitchen ($20 — a treat for the kitchen team). Margaritas: Tommy's Classic $12.95, Cereza Margarita $14.95, Corona-Rita $22.95. Frozen: Frozen Margarita $13.45, Frozen Piña Colada $14.45.", es: "Cócteles ($12.95–$20): Bajapanty, Smoke Some, Como La Flor, Hialeah Ranch Water, Gran Reserva Old Fashioned, Eau de Vie Gives You Wings, Amazonian G&G, The Spicy One, The Old Fashioned, y Round for the Kitchen ($20 — un detalle para el equipo de cocina). Margaritas: Tommy's Classic $12.95, Cereza Margarita $14.95, Corona-Rita $22.95. Frozen: Frozen Margarita $13.45, Frozen Piña Colada $14.45." },
      { en: "Tequila Tasting Flights (Don Julio): Beginners $38 (Blanco/Reposado/Añejo), Ballers $52 (Añejo/70th Anniversary/1942). Zero-proof: Strawberryta $12, Yellow Bull $12, Ponche $10, Botánico $10. Chela's Signature Sangria (white/red/rosé): $14 glass / $56 pitcher.", es: "Flights de Tequila (Don Julio): Beginners $38 (Blanco/Reposado/Añejo), Ballers $52 (Añejo/70 Aniversario/1942). Sin alcohol: Strawberryta $12, Yellow Bull $12, Ponche $10, Botánico $10. Sangría Insignia de Chela's (blanca/roja/rosada): $14 copa / $56 jarra." },
      { en: "Beer: Super Bucket House (5 beers + 5 house tequila shots) $60, Premium (5 beers + 5 Don Julio shots) $85. Draft 19oz ($8–$9): Modelo Especial, Modelo Negra, Mahou, Wynwood La Rubia, Corona Light, Corona Extra, Pacifico, Guinness 16oz. Interesting Beers include No Mames, Ever Haze IPA, Agama Red Ale, Delirium Tremens, Lagunitas IPA, Sixpoint Resin IIPA, Sapporo, and Charro.", es: "Cerveza: Super Bucket House (5 cervezas + 5 shots de tequila de la casa) $60, Premium (5 cervezas + 5 shots Don Julio) $85. De barril 19oz ($8–$9): Modelo Especial, Modelo Negra, Mahou, Wynwood La Rubia, Corona Light, Corona Extra, Pacifico, Guinness 16oz. Cervezas especiales incluyen No Mames, Ever Haze IPA, Agama Red Ale, Delirium Tremens, Lagunitas IPA, Sixpoint Resin IIPA, Sapporo, y Charro." },
      { en: "Wine list: Whites & Rosé (Yealands Sauvignon Blanc, Pighin Pinot Grigio, J. Lohr Chardonnay, Marques de Valor Albariño, Biagio Cru Rosé), Reds (Diora Pinot Noir, San Simeon Cabernet, Baron de Ley Tempranillo, Domaine Bousquet Malbec), Champagne & Bubbles (House Prosecco, Prosecco Zero, Prosecco Rosé, Moët & Chandon Imperial Brut $100).", es: "Carta de vinos: Blancos y Rosados (Yealands Sauvignon Blanc, Pighin Pinot Grigio, J. Lohr Chardonnay, Marques de Valor Albariño, Biagio Cru Rosé), Tintos (Diora Pinot Noir, San Simeon Cabernet, Baron de Ley Tempranillo, Domaine Bousquet Malbec), Champagne y Burbujas (House Prosecco, Prosecco Zero, Prosecco Rosé, Moët & Chandon Imperial Brut $100)." }
    ],
    quiz: [
      { q: { en: "What's included in the Super Bucket (House)?", es: "¿Qué incluye el Super Bucket (House)?" }, options: [{ en: "5 beers + 5 house tequila shots", es: "5 cervezas + 5 shots de tequila de la casa" }, { en: "Only beer", es: "Solo cerveza" }, { en: "5 cocktails", es: "5 cócteles" }, { en: "Only shots", es: "Solo shots" }], correct: 0 },
      { q: { en: "How much is the Ballers tequila flight?", es: "¿Cuánto cuesta el flight de tequila Ballers?" }, options: [{ en: "$52", es: "$52" }, { en: "$38", es: "$38" }, { en: "$20", es: "$20" }, { en: "$100", es: "$100" }], correct: 0 },
      { q: { en: "What's the price of Round for the Kitchen?", es: "¿Cuánto cuesta el Round for the Kitchen?" }, options: [{ en: "$20", es: "$20" }, { en: "$5", es: "$5" }, { en: "$50", es: "$50" }, { en: "Free", es: "Gratis" }], correct: 0 },
      { q: { en: "What's the most expensive item on the Champagne & Bubbles list?", es: "¿Cuál es el artículo más caro en la lista de Champagne y Burbujas?" }, options: [{ en: "Moët & Chandon Imperial Brut ($100)", es: "Moët & Chandon Imperial Brut ($100)" }, { en: "House Prosecco", es: "House Prosecco" }, { en: "Prosecco Zero", es: "Prosecco Zero" }, { en: "Prosecco Rosé", es: "Prosecco Rosé" }], correct: 0 },
  ...
  },
  {
    ...
    quiz: [
      { q: { en: "What does leading by example mean for a manager?", es: "¿Qué significa liderar con el ejemplo para un gerente?" }, options: [{ en: "Demonstrating the professionalism and work ethic you expect from the team", es: "Demostrar el profesionalismo y ética de trabajo que esperas del equipo" }, { en: "Only giving orders", es: "Solo dar órdenes" }, { en: "Avoiding the floor", es: "Evitar el piso" }, { en: "Doing nothing", es: "No hacer nada" }], correct: 0 },
